...
namespace PaintDots.ECS.Examples
{
    ...
    /// </summary>
    // Story: Helper utilities to create and batch multi-tile paint commands (examples and templates).
    ...
    // Story: Generates an example level using multi-tile paint commands once at initialization.
    ...
    /// </summary>
    // Story: Authoring MonoBehaviour for multi-tile prefab templates used by the Baker to bake footprint and visuals.
    public sealed class MultiTileStructureAuthoring : UnityEngine.MonoBehaviour
    {
        ...
        private sealed class Baker : Baker<MultiTileStructureAuthoring>
        {
